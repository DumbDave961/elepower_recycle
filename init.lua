...
local grindings = {
	...
	{"boats:boat",                         "elepower_dynamics:wood_dust 4", 9},
}

if minetest.get_modpath("technic") then
	table.insert(grindings, {"basic_materials:carbon_steel_bar 2",          "technic:carbon_steel_dust", 5})
	table.insert(grindings, {"default:desert_sandstone_block",              "default:desert_sand 2", 8})
	table.insert(grindings, {"default:desert_sandstone_brick",              "default:desert_sand 2", 8})
	...
	table.insert(grindings, {"stairs:slab_sandstone_brick",                 "default:sand", 5})
	...
	table.insert(grindings, {"stairs:stair_sandstone_brick 4",              "default:sand 6", 10})
	...
	table.insert(grindings, {"stairs:stair_inner_sandstone_brick 4",        "default:sand 7", 11})
	...
	table.insert(grindings, {"stairs:stair_outer_sandstone_brick 4",        "default:sand 5", 9})
	...
	table.insert(grindings, {"stairs:slab_desert_sandstone_brick",          "default:silver_sand", 5})
	...
	table.insert(grindings, {"stairs:stair_sandstone_brick 2",              "default:sand 6", 10})
	...
	table.insert(grindings, {"stairs:stair_inner_sandstone_brick 2",        "default:sand 7", 11})
	...
	table.insert(grindings, {"stairs:stair_outer_sandstone_brick 2",        "default:sand 5", 9})
